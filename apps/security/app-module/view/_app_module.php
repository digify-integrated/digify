    ...
    <div class="modal-dialog modal-dialog-scrollable modal-r">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-12 mb-2">
                        <label class="form-label" for="app_module_description">Export To <span class="text-danger">*</span></label>
            ...
            <div class="modal-footer border-top">
                ...
                <button type="button" form="export-form" class="btn btn-success" id="submit-export">Save changes</button>
            </div>
        </div>
    </div>
</div>