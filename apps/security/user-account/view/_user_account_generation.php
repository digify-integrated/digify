    ...
    switch ($type) {
        ...
        case 'app module table':
            ...
            foreach ($options as $row) {
                ...
                $userAccountName = $row['user_account_name'];
                $userAccountDescription = $row['user_account_description'];
                ...
                $response[] = [
                    ...
                    'user_account_NAME' => '<div class="d-flex align-items-center">
                                            <img src="'. $appLogo .'" alt="app-logo" width="45" />
                                            <div class="ms-3">
                                                <div class="user-meta-info">
                                                    <h6 class="mb-0">'. $userAccountName .'</h6>
                                                    <small class="text-wrap">'. $userAccountDescription .'</small>
                                                </div>
                                            </div>
                                        </div>',
