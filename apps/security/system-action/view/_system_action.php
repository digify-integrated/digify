        ...
        <div class="col-md-6 text-end d-flex justify-content-md-end justify-content-center mt-3 mt-md-0">
            <div class="card-actions cursor-pointer ms-auto d-flex button-group">
                <?php
                    ...
                    echo $importAccess['total'] > 0 ? '<a href="' . $pageLink . '&import='. $securityModel->encryptData('system_action') .'" class="btn btn-secondary d-flex align-items-center mb-0"><i class="ti ti-download fs-4 me-1"></i>Import</a>' : '';
