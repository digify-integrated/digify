<?php
    ...
    $page_access = $api->check_role_permissions($username, 113);
    $add_attendance = $api->check_role_permissions($username, 114);
...
<html lang="en">
    ...
    <body data-topbar="dark" data-layout="horizontal">
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-body">
                                            ...
                                            <div class="col-md-12">
                                                <div class="d-flex align-items-start">
                                                    <div class="flex-grow-1 align-self-center">
                                                        <h4 class="card-title">Attendances List</h4>
                                                    </div>
                                                    <div class="d-flex gap-2">
                                                    <?php
                                                        if($add_attendance > 0){
                                                            echo '<button type="button" class="btn btn-primary waves-effect btn-label waves-light" id="add-attendance"><i class="bx bx-plus label-icon"></i> Add</button>';
                                                        }

                                                        if($delete_attendance > 0){
                                                            echo '<button type="button" class="btn btn-danger waves-effect btn-label waves-light d-none multiple" id="delete-attendance"><i class="bx bx-trash label-icon"></i> Delete</button>';
                                                        }
                                                    ?>
                                                ...
                                                <div class="offcanvas offcanvas-end" tabindex="-1" id="filter-off-canvas" data-bs-backdrop="true" aria-labelledby="filter-off-canvas-label">
                                                    ...
                                                    <div class="offcanvas-body">
                                                        <div class="mb-3">
                                                            <p class="text-muted">Time In Date</p>
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-md-12">
                                                <table id="attendance-datatable" class="table table-bordered align-middle mb-0 table-hover table-striped dt-responsive nowrap w-100">
                                                    <thead>
                                                        <tr>
                                                            <th class="all">
        ...
        <script src="assets/js/pages/attendances.js?v=<?php echo rand(); ?>"></script>
    </body>
</html>