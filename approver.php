<?php
    ...
    if($check_user_account_status){
        if($page_access == 0 || !isset($_GET['id']) || empty($_GET['id'])){
            ...
            $id = $_GET['id'];
            $approver_type_id = $api->decrypt_data($id);
        }
    }
    else{
                                ...
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="approver-type.php">Approval Type</a></li>
                                            <li class="breadcrumb-item active"><?php echo $page_title; ?></li>
                                            <li class="breadcrumb-item" id="approver-type-id"><a href="javascript: void(0);"><?php echo $approver_type_id; ?></a></li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
