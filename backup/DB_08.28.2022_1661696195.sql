...
INSERT INTO `global_user_account` VALUES ('ADMIN','68aff5412f35ed76','Administrator','ACTIVE','2023-01-17',0,NULL,'TL-1','UPD->LDAGULTO->2022-07-17 02:23:12'),('LDAGULTO','68aff5412f35ed76','Lawrence Agulto','ACTIVE','2023-01-17',0,'2022-08-28 20:16:07','TL-40','UPD->LDAGULTO->2022-07-17 02:23:26');
...
CREATE TABLE `leave_management` (
  ...
  KEY `leave_management_index` (`LEAVE_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `leave_management` VALUES ('3','3','3','asd','2022-08-03','08:30:00','17:30:00','PEN','2022-08-27 17:33:56',NULL,NULL,NULL,NULL,'TL-28','INS->LDAGULTO->2022-08-27 05:33:56');
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `insert_leave`(IN leave_id VARCHAR(100), IN employee_id VARCHAR(100), IN leave_type_id VARCHAR(100), IN reason VARCHAR(500), IN leave_date DATE, IN start_time TIME, IN end_time TIME, IN created_date DATETIME, IN transaction_log_id VARCHAR(100), IN record_log VARCHAR(100))
BEGIN
	SET @leave_id = leave_id;
	SET @employee_id = employee_id;
	SET @leave_type_id = leave_type_id;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `update_leave`(IN leave_id VARCHAR(100), IN leave_type_id VARCHAR(100), IN reason VARCHAR(500), IN leave_date DATE, IN start_time TIME, IN end_time TIME, IN transaction_log_id VARCHAR(100), IN record_log VARCHAR(100))
BEGIN
	SET @leave_id = leave_id;
	SET @leave_type_id = leave_type_id;
	SET @reason = reason;
...
-- Dump completed on 2022-08-28 22:16:36
