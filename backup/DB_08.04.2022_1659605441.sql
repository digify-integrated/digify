...
--
-- Table structure for table `public_holiday_branch`
--

DROP TABLE IF EXISTS `public_holiday_branch`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `public_holiday_branch`
--

LOCK TABLES `public_holiday_branch` WRITE;
/*!40000 ALTER TABLE `public_holiday_branch` DISABLE KEYS */;
/*!40000 ALTER TABLE `public_holiday_branch` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-08-04 17:30:42
