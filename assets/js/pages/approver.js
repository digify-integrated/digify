...
function initialize_approver_table(datatable_name, buttons = false, show_all = false){
    ...
    var approver_type_id = $('#approver-type-id').text();
    ...
    if(buttons){
        settings = {
            'ajax': { 
                ...
                'method' : 'POST',
                'dataType': 'JSON',
                'data': {'type' : type, 'username' : username, 'approver_type_id' : approver_type_id},
                'dataSrc' : ''
            },
...
function initialize_click_events(){
    ...
    $(document).on('click','.update-approver',function() {
        var approver_id = $(this).data('approver-id'); 
        
        sessionStorage.setItem('approver_id', approver_id);
        
        generate_modal('approver form', 'Approver', 'R' , '1', '1', 'form', 'approver-form', '0', username);
    });
        ...
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    type: 'POST',
                    url: 'controller.php',
                    data: {username : username, approver_id : approver_id, transaction : transaction},
