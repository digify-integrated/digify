    ...
    if(buttons){
        settings = {
            'ajax': { 
                ...
                'method' : 'POST',
                'dataType': 'JSON',
                'data': {'type' : type, 'username' : username , 'filter_user_account_lock_status' : filter_user_account_lock_status, 'filter_user_account_status' : filter_user_account_status, 'filter_start_date' : filter_start_date, 'filter_end_date' : filter_end_date},
                'dataSrc' : ''
            },
