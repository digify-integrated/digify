...
function initialize_click_events(){
    ...
    $(document).on('click','.update-company',function() {
        ...
        generate_modal('company form', 'Company', 'XL' , '1', '1', 'form', 'company-form', '0', username);
    });
    ...
    $(document).on('click','#delete-company',function() {
        ...
        if(company_id.length > 0){
            ...
            show_alert('Delete Multiple Companies', 'Please select the companies you want to delete.', 'error');
        }
    });
