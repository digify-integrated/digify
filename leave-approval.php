<?php
    ...
    $page_access = $api->check_role_permissions($username, 196);
                                            ...
                                            <div class="col-md-12">
                                                <div class="d-flex align-items-start">
                                                    ...
                                                    <?php
                                                        ...
                                                        if($reject_leave > 0){
                                                            echo '<button type="button" class="btn btn-danger waves-effect btn-label waves-light d-none multiple-reject" id="reject-leave"><i class="bx bx-x label-icon"></i> Reject</button>';
                                                        }
